...
namespace HidSharp.Platform.Linux
{
    abstract class NativeMethodsLibudev
    {
        ...
        public abstract IntPtr udev_unref(IntPtr udev);

        public abstract IntPtr udev_monitor_new_from_netlink(IntPtr udev, string name);

        public abstract IntPtr udev_monitor_unref(IntPtr monitor);
        ...
        public abstract IntPtr udev_enumerate_unref(IntPtr enumerate);
        ...
        public abstract IntPtr udev_device_unref(IntPtr device);
